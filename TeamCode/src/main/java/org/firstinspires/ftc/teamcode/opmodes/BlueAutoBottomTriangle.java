...
@Autonomous(name = "Auto - blue (triangle)", group = "Examples")
public class BlueAutoBottomTriangle extends OpMode {
	...
	private final Pose startPose = new Pose(55.9, 8.5, Math.toRadians(90));
