...
public class CommonPositions {
    ...
    public static final Pose BLUE_AUTO_NEAR_END = new Pose(58.0, 114.0, Math.toRadians(180));
    public static final Pose RED_AUTO_FAR_END = new Pose(106.0, 12.0, Math.toRadians(0));
    public static final Pose RED_AUTO_NEAR_END = new Pose(88.0, 114.0, Math.toRadians(0));
    ...
    public static final Pose RED_AUTO_NEAR_START_PICKUP = new Pose(98.0, 83.0, Math.toRadians(0));
    public static final Pose RED_AUTO_NEAR_END_PICKUP = new Pose(124.0, 83.0, Math.toRadians(0));

    public static final Pose BLUE_AUTO_NEAR_START_PICKUP = new Pose(45.0, 83.0, Math.toRadians(180));
    public static final Pose BLUE_AUTO_NEAR_END_PICKUP = new Pose(19.0, 83.0, Math.toRadians(180));

    /// Intake when in far zone
    public static final Pose RED_AUTO_FAR_START_PICKUP = new Pose(98.0, 35.0, Math.toRadians(0));
    public static final Pose RED_AUTO_FAR_END_PICKUP = new Pose(124.0, 35.0, Math.toRadians(0));

    public static final Pose BLUE_AUTO_FAR_START_PICKUP = new Pose(45.0, 35.0, Math.toRadians(180));
    public static final Pose BLUE_AUTO_FAR_END_PICKUP = new Pose(19.0, 35.0, Math.toRadians(180));
}
